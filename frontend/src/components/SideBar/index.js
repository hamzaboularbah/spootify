    ...
    return (
        <Container>
            ...
            <Section>
                ...
                <ItemsList>
                    <Item>
                        <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg"><path d="M15.909 16.479l-4.572-4.665a6.26 6.26 0 0 0 1.889-4.474c0-3.496-2.899-6.34-6.462-6.34C3.201 1 .302 3.844.302 7.34c0 3.495 2.899 6.34 6.462 6.34 1.564 0 3-.55 4.118-1.46l4.583 4.677a.31.31 0 0 0 .435.008.298.298 0 0 0 .009-.426zm-9.145-3.404C3.54 13.075.918 10.502.918 7.34c0-3.163 2.622-5.736 5.846-5.736S12.61 4.177 12.61 7.34c0 3.162-2.623 5.735-5.846 5.735z" opacity=".7" /></svg>
                        <p>Explore</p>
                    </Item>
                    <Item>
                        <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg"><g ><path d="M11 0C4.935 0 0 4.935 0 11s4.935 11 11 11 11-4.935 11-11S17.065 0 11 0zm0 21.267C5.339 21.267.733 16.66.733 11S5.34.733 11 .733 21.267 5.34 21.267 11 16.66 21.267 11 21.267z" /><path d="M11 8.067A2.937 2.937 0 0 0 8.067 11 2.937 2.937 0 0 0 11 13.933 2.937 2.937 0 0 0 13.933 11 2.937 2.937 0 0 0 11 8.067zm0 5.133c-1.213 0-2.2-.987-2.2-2.2s.987-2.2 2.2-2.2 2.2.987 2.2 2.2-.987 2.2-2.2 2.2z" /><path d="M11 5.867A5.139 5.139 0 0 0 5.867 11 5.139 5.139 0 0 0 11 16.133 5.139 5.139 0 0 0 16.133 11 5.139 5.139 0 0 0 11 5.867zm0 9.533A4.405 4.405 0 0 1 6.6 11c0-2.426 1.974-4.4 4.4-4.4s4.4 1.974 4.4 4.4-1.974 4.4-4.4 4.4z" /></g></svg>
                        <p>Hear this</p>
                    </Item>
                    <Item>
