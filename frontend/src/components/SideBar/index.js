...
const SideBar = ({ profile }) => {
    ...
    useEffect(() => {
        ...
        fetch(options.url, { headers: options.headers }).then(response => response.json()).then(playlists => setPlaylists(playlists))
    }, [])
    return (
        <Container>
            ...
            <Section>
                ...
                <ItemsList>
                    <Item>
                        <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg"><path d="M15.909 16.479l-4.572-4.665a6.26 6.26 0 0 0 1.889-4.474c0-3.496-2.899-6.34-6.462-6.34C3.201 1 .302 3.844.302 7.34c0 3.495 2.899 6.34 6.462 6.34 1.564 0 3-.55 4.118-1.46l4.583 4.677a.31.31 0 0 0 .435.008.298.298 0 0 0 .009-.426zm-9.145-3.404C3.54 13.075.918 10.502.918 7.34c0-3.163 2.622-5.736 5.846-5.736S12.61 4.177 12.61 7.34c0 3.162-2.623 5.735-5.846 5.735z" fill="#FFF" stroke="#FFF" opacity=".7" /></svg>
                        <p>Explore</p>
                    </Item>
                    <Item>
                        <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg"><g fill="#FFF"><path d="M11 0C4.935 0 0 4.935 0 11s4.935 11 11 11 11-4.935 11-11S17.065 0 11 0zm0 21.267C5.339 21.267.733 16.66.733 11S5.34.733 11 .733 21.267 5.34 21.267 11 16.66 21.267 11 21.267z" /><path d="M11 8.067A2.937 2.937 0 0 0 8.067 11 2.937 2.937 0 0 0 11 13.933 2.937 2.937 0 0 0 13.933 11 2.937 2.937 0 0 0 11 8.067zm0 5.133c-1.213 0-2.2-.987-2.2-2.2s.987-2.2 2.2-2.2 2.2.987 2.2 2.2-.987 2.2-2.2 2.2z" /><path d="M11 5.867A5.139 5.139 0 0 0 5.867 11 5.139 5.139 0 0 0 11 16.133 5.139 5.139 0 0 0 16.133 11 5.139 5.139 0 0 0 11 5.867zm0 9.533A4.405 4.405 0 0 1 6.6 11c0-2.426 1.974-4.4 4.4-4.4s4.4 1.974 4.4 4.4-1.974 4.4-4.4 4.4z" /></g></svg>
                        <p>Hear this</p>
                    </Item>
                    <Item>
                        <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg"><g fill="#FFF" opacity=".7"><path d="M12.594 11.586a.41.41 0 0 0-.406.414v2.483c0 3.194-2.552 5.793-5.688 5.793-3.136 0-5.688-2.599-5.688-5.793V12a.41.41 0 0 0-.406-.414A.41.41 0 0 0 0 12v2.483c0 3.51 2.7 6.384 6.094 6.6v2.09H4.062a.41.41 0 0 0-.406.413.41.41 0 0 0 .406.414h4.875a.41.41 0 0 0 .407-.414.41.41 0 0 0-.406-.414H6.905v-2.09c3.395-.215 6.094-3.089 6.094-6.6V12a.41.41 0 0 0-.406-.414z" /><path d="M6.5 19.034c2.464 0 4.469-2.042 4.469-4.551V4.552C10.969 2.042 8.964 0 6.5 0 4.036 0 2.031 2.042 2.031 4.552v9.93c0 2.51 2.005 4.552 4.469 4.552zM2.844 4.552C2.844 2.498 4.484.828 6.5.828s3.656 1.67 3.656 3.724v9.93c0 2.054-1.64 3.725-3.656 3.725s-3.656-1.67-3.656-3.724V4.552z" /></g></svg>
                        <p>Radio</p>
                    </Item>
                </ItemsList>
            </Section>
                ...
                <ItemsList>
                    {playlists.items
                        && playlists.items.map(playlist =>
                            <Item>
                                <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg"><g fill-rule="nonzero" fill="#FFF" opacity=".7"><path d="M3.667 0H0v19h22V0H3.667zm-.734 18.27h-2.2V.73h2.2v17.54zm18.334 0h-17.6V.73h17.6v17.54z" /><path d="M7.883 15.712c1.296 0 2.351-.957 2.38-2.142.001-.005.004-.009.004-.014V7.255l6.233-.98v3.474a2.486 2.486 0 0 0-1.65-.613c-1.314 0-2.383.983-2.383 2.192s1.069 2.192 2.383 2.192 2.383-.983 2.383-2.192V3.654a.364.364 0 0 0-.424-.361L9.842 4.389a.366.366 0 0 0-.309.361v7.191a2.486 2.486 0 0 0-1.65-.614c-1.314 0-2.383.983-2.383 2.192 0 1.21 1.07 2.193 2.383 2.193zm6.967-2.924c-.91 0-1.65-.655-1.65-1.461s.74-1.462 1.65-1.462c.91 0 1.65.656 1.65 1.462 0 .806-.74 1.461-1.65 1.461zm-4.583-7.726l6.233-.981v1.453l-6.233.98V5.063zm-2.384 6.996c.91 0 1.65.655 1.65 1.461s-.74 1.462-1.65 1.462c-.91 0-1.65-.656-1.65-1.462 0-.806.74-1.461 1.65-1.461z" /></g></svg>
                                <p>{playlist.name}</p>
                            </Item>
                        )}
                </ItemsList>
